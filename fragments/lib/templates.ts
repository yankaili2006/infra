...
const templates = {
  'base': {
    name: 'Base Linux environment',
    lib: ['bash', 'coreutils', 'curl', 'git'],
    file: 'script.sh',
    instructions:
      'A basic Linux environment for running shell commands and scripts. Use for general command-line tasks, file operations, and system administration.',
    port: null,
  },
  'desktop-template-000-0000-0000-000000000001': {
    name: 'Desktop environment',
    lib: ['vnc', 'x11', 'firefox', 'desktop-tools'],
    file: null,
    instructions:
      'A full desktop environment with VNC access. Use for GUI applications, browser automation, and visual tasks requiring desktop interaction.',
    port: 5900,
  },
  'code-interpreter-v1': {
